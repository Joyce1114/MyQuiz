...
public class ImageQuizActivity extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Log.d("SHAREDPREFERENCES", String.valueOf(mSharedChecked));
    ...
    public void onStop() {
        ...
        mJSonAnswers = gson.toJson(mAnswers);
    ...
    public void savesharedpreference() {
        ...
        editor.putString(JSONANSWERS, mJSonAnswers);
    ...
    public void getsharedpreference() {
        ...
        mJSonAnswers = sp.getString(JSONANSWERS, null);
        Gson gson = new Gson();
        mQuiz = gson.fromJson(mJSonQuiz, Quiz.class);
        mAnswers = gson.fromJson(mJSonAnswers, new TypeToken<ArrayList<String>>() {
        }.getType());
        updateScore();
    }
